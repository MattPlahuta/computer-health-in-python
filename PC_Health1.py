...
class PcHealth:
    ...
    def __init__(self, hostname):
        ...
        xxxx = hostname[0:5]
        self.v6 = str("hostname of router vlan you want")
        self.v11 = str("hostname of router vlan you want")
        try:                             # Attempts to create a WMI session with remote computer
            objWMIService = win32com.client.Dispatch("WbemScripting.SWbemLocator")
            self.objSWbemServices = objWMIService.ConnectServer(hostname, "root\cimv2", username, password)
            self.c = wmi.WMI(hostname, user = username, password = password)
    ...
    def last_build(self):
        ...
        file_list = []
        try:
            directory = "\\\\"+(self.hostname)+"/c$/Build_Result"                  # Grabs the name of file in build_results folder
    ...
    def system_uptime(self):
        ...
        try:
            ...
            #print e
            print "Unable to pull all information."
        print
    ...
    def network_info(self):
        ...
        try:
            ...
            hostip = socket.gethostbyname(self.hostname)                           # Grabs IP of the hostname
            VLAN11 = socket.gethostbyname(self.v11)                                # Grabs IP of the routers vlan 11
            VLAN6 = socket.gethostbyname(self.v6)                                  # Grabs IP of the routers vlan 6
            host = hostip.split ('.')[2]
            v11 = VLAN11.split ('.')[2]
            v6 = VLAN6.split ('.')[2]
            if host == v11:
            ...
            #print e
            print "Unable to gather all network information."     
